...
export default function SectionSecondHome({addeddelay = 0} : Readonly<{addeddelay? : number}>)
{
    ...
    const header1 = "One place to stash you new ideas"
    const header2 = "A place where you can keep all your ideas"
